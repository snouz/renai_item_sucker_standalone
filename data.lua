local renaiTechIcons = "__renai_item_sucker_standalone__/graphics/technology/"
local renaiIcons = "__renai_item_sucker_standalone__/graphics/icons/"
local renaiEntity = "__renai_item_sucker_standalone__/graphics/entity/"
local renaiSounds = "__renai_item_sucker_standalone__/sounds/"
...
---- vacuum hatch ----
{
	...
	minable = {mining_time = 0.5, result = "RTVacuumHatch_standalone"},
	energy_source =
	{
		type = "electric",
...
{ --------- The vacuum hatch recipe ----------
	...
	results = {
		{type = "item", name = "RTVacuumHatch_standalone", amount = 1}
	}
...
{ --------- The vacuum hatch item -------------
	...
	--subgroup = "RT",
	order = "f-c",
	place_result = "RTVacuumHatch_standalone",
	stack_size = 50
},

{
	type = "animation",
	name = "VacuumHatchSucc_standalone",
...
{
	type = "technology",
	name = "RTVacuumHatchTech_standalone",
	...
	effects =
	{
		{
			type = "unlock-recipe",
			recipe = "RTVacuumHatch_standalone"
		},
	},
